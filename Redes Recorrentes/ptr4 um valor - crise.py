...
#==== Estrutura dos dados ====
base = pd.read_csv('petr4_treinamento_crise.csv')
...
base_teste = pd.read_csv('petr4_teste_crise.csv')
...
X_teste = []
for i in range(90, 109): #for parecido com o anterior pra pegar lotes de 90 dias
