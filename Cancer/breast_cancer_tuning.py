...
def criarRede(optimizer, loos, kernel_initializer, activation, neurons):
    ...
    classificador.add(Dense(units = neurons, activation = activation, 
                        kernel_initializer = kernel_initializer, input_dim=30)) #primeira camada oculta
    classificador.add(Dropout(0.2)) #Dropout ajuda a diminuir o overfiting
    classificador.add(Dense(units = neurons, activation = activation, 
                        kernel_initializer = kernel_initializer)) #segunda camada oculta
