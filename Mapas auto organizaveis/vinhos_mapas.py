...
X = base.iloc[:,1:14].values #Todas as colunas  menos a primeira e a ultima
y = base.iloc[:,0].values #Pegando a primeira coluna - classes
...
som.train_random(data = X, num_iteration = 100) #num_iteration = epocas
...
markers = ['o', 's', 'D'] # o = bolinha, s = square, D = Logango
color = ['r', 'g', 'b']
y[y == 1] = 0
y[y == 2] = 1
y[y == 3] = 2
